...
step9 = importlib.import_module("tml-solutions.mytestprojectmain-3f10.tml_system_step_9_privategpt_qdrant_dag-mytestprojectmain-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ml_restapi_dag-mytestprojectmain-3f10",
