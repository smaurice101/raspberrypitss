...
default_args = {
 ...
 'solutionname': 'rogue-agents-cncf-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'Rogue Agent Monitoring Solution', # <<< *** Provide a descriptive title for your solution
