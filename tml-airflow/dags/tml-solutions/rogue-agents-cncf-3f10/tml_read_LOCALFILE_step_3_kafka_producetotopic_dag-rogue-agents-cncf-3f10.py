...
default_args = {
    ...
    'inputfile': '/rawdatademo/rogueagentsdata.txt', # <<< ***** replace ?  to input file name to read. NOTE this data file should be JSON messages per line and stored in the HOST folder mapped to /rawdata folder
