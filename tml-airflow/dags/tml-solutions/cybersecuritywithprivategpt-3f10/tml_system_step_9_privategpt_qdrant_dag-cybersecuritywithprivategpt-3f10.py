...
default_args = {
 ...
 'pgptcontainername' : 'maadsdocker/tml-privategpt-with-gpu-nvidia-amd64-deepseek',# 'maadsdocker/tml-privategpt-with-gpu-nvidia-amd64-v2', #'maadsdocker/tml-privategpt-no-gpu-amd64',  # enter a valid container https://hub.docker.com/r/maadsdocker/tml-privategpt-no-gpu-amd64
