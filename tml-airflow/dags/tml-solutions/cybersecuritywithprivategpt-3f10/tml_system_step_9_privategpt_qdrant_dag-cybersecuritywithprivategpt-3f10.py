...
default_args = {
 ...
 'prompt': 'Does the IP address 192.168.--identifier-- show an any risk of a cyber attack?', # Enter your prompt here
...
anomaly probabilities are less than 0.60, it is likely the risk of a cyber attack is also low. If its above 0.60, then risk is mid to high.', # what is this data about? Provide context to PrivateGPT
 ...
 'docfolderingestinterval': '60', # how often you want TML to RE-LOAD the files in docfolder - enter the number of SECONDS
