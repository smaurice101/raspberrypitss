...
default_args = {
  ...
  'dashboardhtml-ml-ai': 'tml-cisco-network-privategpt-monitor.html', # <<< *** This one is you include ML-AI dag
  'topic-ml-ai' : 'cisco-network-preprocess,cisco-network-privategpt',    # <<< *** Separate multiple topics by a comma      
