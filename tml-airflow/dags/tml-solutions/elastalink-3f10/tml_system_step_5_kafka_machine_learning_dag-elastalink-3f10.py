...
default_args = {
  ...
  'independentvariables': 'Latency_preprocessed_Avg', # <<< *** Change as needed, 
  ...
  'processlogic' : 'classification_name=failure_prob:Latency_preprocessed_Avg=30,n',  # <<< *** Change as needed, i.e. classification_name=failure_prob:Voltage_preprocessed_AnomProb=55,n:Current_preprocessed_AnomProb=55,n
  'array' : '0',  # leave as is
