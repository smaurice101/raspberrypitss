...
default_args = {
  ...
  'processlogic' : 'classification_name=failure_prob:CPULoad_preprocessed_Avg=50,n:Latency_preprocessed_Avg=55,n',  # <<< *** Change as needed, i.e. classification_name=failure_prob:Voltage_preprocessed_AnomProb=55,n:Current_preprocessed_AnomProb=55,n
  'array' : '0',  # leave as is
