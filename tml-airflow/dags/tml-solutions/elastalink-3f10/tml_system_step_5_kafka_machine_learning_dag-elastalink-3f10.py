...
default_args = {
  ...
  'independentvariables': 'BandwidthUtilization_preprocessed_Avg', # <<< *** Change as needed, 
  'rollbackoffsets' : '1100', # <<< *** Change as needed, 
  ...
  'processlogic' : 'classification_name=failure_prob:BandwidthUtilization_preprocessed_Avg=200,n',  # <<< *** Change as needed, i.e. classification_name=failure_prob:Voltage_preprocessed_AnomProb=55,n:Current_preprocessed_AnomProb=55,n
  'array' : '0',  # leave as is
