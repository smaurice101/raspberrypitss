...
default_args = {
  ...
  'docfolder' : '/rawdata/mylog,/rawdata/mylog2', # You can read TEXT files or any file in these folders that are inside the volume mapped to /rawdata
  'doctopic' : 'rtms-stream-mylog,rtms-stream-mylog2',  # This is the topic that will contain the docfolder file data
