...
default_args = {
    ...
    'preprocesstypes': 'anomprob,trend,std', # <<< **** MAIN PREPROCESS TYPES CHNAGE AS NEEDED refer to https://tml-readthedocs.readthedocs.io/en/latest/
...
msgid=datapoint.id~\
latlong=lat:long2""",  # <<< **** Specify your json criteria. Here is an example of a multiline json --  refer to https://tml-readthedocs.readthedocs.io/en/latest/
}
