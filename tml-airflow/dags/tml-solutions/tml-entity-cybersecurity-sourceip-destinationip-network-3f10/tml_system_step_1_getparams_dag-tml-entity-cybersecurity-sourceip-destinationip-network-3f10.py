...
default_args = {
 ...
 'solutionname': 'tml-entity-cybersecurity-sourceip-destinationip-network-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'TML Entity Based Cybersecurity Solution', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This is an awesome real-time cybersecurity solution built by TSS',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
