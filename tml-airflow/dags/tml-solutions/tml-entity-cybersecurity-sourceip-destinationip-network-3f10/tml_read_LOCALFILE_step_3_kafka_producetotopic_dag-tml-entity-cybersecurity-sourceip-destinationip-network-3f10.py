...
default_args = {
  ...
  'inputfile' : '/rawdata/situng-zeekconn-ldjson.json',  # <<< ***** replace ?  to input file name to read. NOTE this data file should be JSON messages per line and stored in the HOST folder mapped to /rawdata folder 
