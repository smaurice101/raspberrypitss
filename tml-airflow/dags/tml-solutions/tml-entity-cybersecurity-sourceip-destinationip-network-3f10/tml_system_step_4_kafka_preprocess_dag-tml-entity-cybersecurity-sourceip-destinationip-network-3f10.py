...
default_args = {
  ...
  'preprocesstypes' : 'anomprob,trend,avg,min,max,skewness,kurtosis,sum,outliers,mad,gm,trimean', # <<< **** MAIN PREPROCESS TYPES CHNAGE AS NEEDED refer to https://tml-readthedocs.readthedocs.io/en/latest/
