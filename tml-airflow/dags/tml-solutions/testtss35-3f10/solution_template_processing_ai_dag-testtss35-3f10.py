...
step3 = importlib.import_module("tml-solutions.testtss35-3f10.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-testtss35-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ai_dag-testtss35-3f10",
