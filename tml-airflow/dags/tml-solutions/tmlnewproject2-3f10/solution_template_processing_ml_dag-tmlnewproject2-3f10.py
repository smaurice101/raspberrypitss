...
step3 = importlib.import_module("tml-solutions.tmlnewproject2-3f10.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-tmlnewproject2-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ml_dag-tmlnewproject2-3f10",
