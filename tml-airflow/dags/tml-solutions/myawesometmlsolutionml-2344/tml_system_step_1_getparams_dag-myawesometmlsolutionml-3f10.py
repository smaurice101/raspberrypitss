...
default_args = {
 ...
 'solutionname': 'myawesometmlsolutionml-$pac',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolutionml-$pac", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolutionml-$pac"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
