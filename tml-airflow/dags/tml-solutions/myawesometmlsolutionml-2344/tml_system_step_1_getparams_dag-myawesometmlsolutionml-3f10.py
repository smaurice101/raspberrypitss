...
default_args = {
 ...
 'solutionname': 'myawesometmlsolutionml-2344',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolutionml-2344", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolutionml-2344"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
