...
@dag(dag_id="container_run_stop_process_dag_myawesometmlsolutionml-$pac", default_args=default_args, tags=["container_run_stop_process_dag_myawesometmlsolutionml-$pac"], schedule=None,  catchup=False)
