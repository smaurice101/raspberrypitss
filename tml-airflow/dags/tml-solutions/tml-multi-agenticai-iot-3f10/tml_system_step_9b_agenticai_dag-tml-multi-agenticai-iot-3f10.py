...
default_args = {
 ...
 'agents_topic_prompt' : """
      ...
      Perform these exact steps only: 
       1. based on the value of the hp field determine if the value exceed 85, if so it has a high probability of failure and should be flagged and investigated.
