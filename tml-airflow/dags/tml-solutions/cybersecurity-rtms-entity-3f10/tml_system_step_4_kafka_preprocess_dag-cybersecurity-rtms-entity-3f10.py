...
default_args = {
  ...
  'raw_data_topic' : 'rtms-raw-entity', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'preprocess_data_topic' : 'rtms-raw-preprocess', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
...
datetime=datetime~\
msgid=logfile,event_type_PSI,pattern_score,raw_rtms_score,normalized_rtms_score,mitre_classification.tactic,mitre_classification.technique,log_file~\
