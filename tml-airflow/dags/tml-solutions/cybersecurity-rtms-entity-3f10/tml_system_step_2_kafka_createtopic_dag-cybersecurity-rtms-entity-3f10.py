...
default_args = {
    ...
    'raw_data_topic': 'rtms-raw-entity', # Separate multiple topics with comma <<< ********** You change topic names as needed
    'preprocess_data_topic': 'rtms-entity-preprocess,rtms-preprocess,rtms-raw-preprocess', # Separate multiple topics with comma <<< ********** You change topic names as needed
