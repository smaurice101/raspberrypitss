...
default_args = {
 ...
 'solutiontitle': 'HYSYS Solution Oil and Gas Solution Demo', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This solution is processing data from HYSYS',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
