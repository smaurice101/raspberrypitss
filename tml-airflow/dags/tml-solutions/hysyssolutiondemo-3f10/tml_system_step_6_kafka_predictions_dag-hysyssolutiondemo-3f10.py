...
default_args = {
  ...
  'streamstojoin' : 'psia_preprocessed_Avg,Choke_A_preprocessed_Avg,V-200_preprocessed_Avg,F_preprocessed_Avg,PIC-100_preprocessed_Avg,LIC-101_preprocessed_Avg', # << ** These are the streams in the preprocess_data_topic for these independent variables
