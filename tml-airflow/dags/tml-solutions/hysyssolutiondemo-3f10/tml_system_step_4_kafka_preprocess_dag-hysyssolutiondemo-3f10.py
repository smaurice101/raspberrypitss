...
default_args = {
  ...
  'identifier' : 'Hysys Solution Demo', # <<< ** Change as needed
...
subtopics=Vapor1.Name,Datapoint.Pressure.Unit,Children.ChokeA.Name,Children.V200.Pressure.Unit,Children.V200.Temperature.Unit, Children.Pic100.Name,Children.Lic101.Name~\
values=Vapor1.GasFlowRate.Value,Pressure.Value,Children.ChokeA.OutletPressure.Value,Children.V200.Pressure.Value,Children.V200.Temperature.Value,Children.Pic100.SetPoint.Value,Children.Lic101.SetPoint.Value~\
identifiers=Vapor1.Name,Datapoint.Pressure.Unit,Children.ChokeA.Name,Children.V200.Pressure.Unit,Children.V200.Temperature.Unit, Children.Pic100.Name,Children.Lic101.Name~\
