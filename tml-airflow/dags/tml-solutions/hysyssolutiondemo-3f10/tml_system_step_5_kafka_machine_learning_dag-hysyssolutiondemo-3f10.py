...
default_args = {
  ...
  'independentvariables': 'psia_preprocessed_Avg,Choke_A_preprocessed_Avg,V-200_preprocessed_Avg,F_preprocessed_Avg,PIC-100_preprocessed_Avg,LIC-101_preprocessed_Avg', # <<< *** Change as needed, 
