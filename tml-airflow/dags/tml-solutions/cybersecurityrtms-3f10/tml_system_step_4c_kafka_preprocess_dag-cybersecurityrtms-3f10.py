...
default_args = {
  ...
  'searchterms' : '@authentication failure,192.168.--entity--,Invalid user ~ |invalid user,attack', # main Search terms, if AND add @, if OR use | s first characters, default OR
