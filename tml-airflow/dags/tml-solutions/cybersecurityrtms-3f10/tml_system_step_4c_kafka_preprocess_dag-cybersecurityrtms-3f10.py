...
default_args = {
  ...
  'searchterms' : '@authentication failure,192.168.--entity--,Invalid user ~ |unknown user,attack', # main Search terms, if AND add @, if OR use | s first characters, default OR
