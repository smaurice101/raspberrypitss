...
default_args = {
  ...
  'searchterms' : '@authentication failures,192.168.--entity-- password failure ~ |unknown 192.168.--entity--', # main Search terms, if AND add @, if OR use | s first characters, default OR
