...
step3 = importlib.import_module("tml-solutions.iotsolution-534a.tml_read_gRPC_step_3_kafka_producetotopic_dag-iotsolution-534a")
...
with DAG(
    dag_id="solution_preprocessing_ml_grpc_dag-iotsolution-534a",
