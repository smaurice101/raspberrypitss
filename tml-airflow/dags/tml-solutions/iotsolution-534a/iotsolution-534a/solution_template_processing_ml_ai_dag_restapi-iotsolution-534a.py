...
step3 = importlib.import_module("tml-solutions.iotsolution-534a.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-iotsolution-534a")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-iotsolution-534a",
