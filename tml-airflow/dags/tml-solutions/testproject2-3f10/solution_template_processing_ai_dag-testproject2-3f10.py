...
step3 = importlib.import_module("tml-solutions.testproject2-3f10.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-testproject2-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ai_dag-testproject2-3f10",
