...
step3 = importlib.import_module("tml-solutions.testproject4-3f10.tml_read_gRPC_step_3_kafka_producetotopic_dag-testproject4-3f10")
...
with DAG(
    dag_id="solution_preprocessing_ai_grpc_dag-testproject4-3f10",
