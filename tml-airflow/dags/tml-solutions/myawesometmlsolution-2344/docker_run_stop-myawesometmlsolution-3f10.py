...
@dag(dag_id="container_run_stop_process_dag_myawesometmlsolution-$pac", default_args=default_args, tags=["container_run_stop_process_dag_myawesometmlsolution-$pac"], schedule=None,  catchup=False)
