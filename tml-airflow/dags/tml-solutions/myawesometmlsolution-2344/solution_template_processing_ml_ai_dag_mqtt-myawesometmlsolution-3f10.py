...
step1 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_1_getparams_dag-myawesometmlsolution-$pac")
step2 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolution-$pac")
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_read_MQTT_step_3_kafka_producetotopic_dag-myawesometmlsolution-$pac")
step4 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolution-$pac")
step5 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolution-$pac")
step6 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_6_kafka_predictions_dag-myawesometmlsolution-$pac")
step7 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_7_kafka_visualization_dag-myawesometmlsolution-$pac")
step8 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolution-$pac")
step9 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolution-$pac")
step10 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_system_step_10_documentation_dag-myawesometmlsolution-$pac")


with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-myawesometmlsolution-$pac",
