...
@dag(dag_id="tml_system_step_10_documentation_dag_myawesometmlsolution-$pac", default_args=default_args, tags=["tml_system_step_10_documentation_dag_myawesometmlsolution-$pac"], schedule=None,  catchup=False)
