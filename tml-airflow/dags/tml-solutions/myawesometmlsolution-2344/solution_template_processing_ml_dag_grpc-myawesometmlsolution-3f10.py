...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-$pac.tml_read_gRPC_step_3_kafka_producetotopic_dag-myawesometmlsolution-$pac")
...
with DAG(
    dag_id="solution_preprocessing_ml_grpc_dag-myawesometmlsolution-$pac",
