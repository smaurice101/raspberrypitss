...
default_args = {
  ...
  'processlogic' : 'classification_name=failure_prob:Power_preprocessed_Avg=0',  # <<< *** Change as needed, i.e. classification_name=failure_prob:Voltage_preprocessed_AnomProb=55,n:Current_preprocessed_AnomProb=55,n
  'array' : '0',  # leave as is
