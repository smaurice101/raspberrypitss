...
default_args = {
  ...
  'independentvariables': 'Voltage_preprocessed_Trend,Current_preprocessed_Trend', # <<< *** Change as needed, 
  ...
  'processlogic' : 'classification_name=failure_prob:Voltage_preprocessed_AnomProb=-n,0:Current_preprocessed_AnomProb=-n,0',  # <<< *** Change as needed, i.e. classification_name=failure_prob:Voltage_preprocessed_AnomProb=55,n:Current_preprocessed_AnomProb=55,n
  'array' : '0',  # leave as is
