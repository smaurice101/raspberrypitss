...
default_args = {
  ...
  'streamstojoin' : 'Voltage_preprocessed_Trend,Current_preprocessed_Trend', # << ** These are the streams in the preprocess_data_topic for these independent variables
