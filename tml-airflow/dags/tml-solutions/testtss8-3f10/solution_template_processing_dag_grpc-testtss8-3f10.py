...
step3 = importlib.import_module("tml-solutions.testtss8-3f10.tml_read_gRPC_step_3_kafka_producetotopic_dag-testtss8-3f10")
...
with DAG(
    dag_id="solution_preprocessing_dag_grpc-testtss8-3f10",
